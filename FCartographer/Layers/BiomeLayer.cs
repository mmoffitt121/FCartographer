...
namespace FCartographer
{
    ...
    public class BiomeLayer : Layer
    {
        ...
        /// </summary>
        public BiomeLayer(int x, int y) : base(x, y, "Nations Layer", "Nations Layer Description")
        {
            SetType(LayerType.Biome);
            SetName("Biome Layer");
        ...
        /// </summary>
        public BiomeLayer(int x, int y, string _name) : base(x, y, _name, "Nations Layer", "Nations Layer Description")
        {
            SetType(LayerType.Biome);
